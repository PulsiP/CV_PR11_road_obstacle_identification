...
OBS_LABEL2COLOR = {label.trainId: label.color for label in OBS_LABEL if label.trainId != 255}
...
CSB_COLOR2LABEL = {label.color: label.trainId for label in CS_BLABEL if label.trainId != 255}
OBS_COLOR2LABEL = {label.color: label.trainId for label in OBS_LABEL if label.trainId != 255}
