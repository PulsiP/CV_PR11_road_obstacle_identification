...
CS_LABEL = [
    ...
    Label("license plate",          -1,     6, "vehicle", 7, False, True, (0, 0, 142)), # remap -1 -> 19
]
...
CS_LABEL2COLOR[0] = (0, 0, 0)  # colore per ignore label
...
CSB_COLOR2LABEL = {label.color: label.trainId for label in CS_BLABEL}
